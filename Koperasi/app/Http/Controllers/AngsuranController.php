...
class AngsuranController extends Controller
{
    ...
    {
        $angsurans = Angsuran::with(['anggota', 'pinjaman'])->get();
        $angsuransByPinjaman = $angsurans->groupBy('id_pinjaman');
        return view('angsuran.index', compact('angsurans', 'angsuransByPinjaman'));
    }
